...
local CATS = {
    { key = "skin",      label = "Skin Tone",   fb = 9,  region = 0, colorRegions = { 0, 1 }, color = true,  glow = "blue",
      desc = "Body skin tone + overlay + free recolor of skin & face." },
    { key = "face",      label = "Face",        fb = 9,  region = 1, color = false, glow = "gold",
      desc = "Facial features (recolored with Skin Tone)." },
    { key = "hair",      label = "Hair Style",  fb = 11, region = 2, color = false, glow = "gold",
      desc = "Hairstyle geoset (recolored by Hair Color)." },
    { key = "haircolor", label = "Hair Color",  fb = 9,  region = 2, colorRegions = { 2, 3 }, color = true,  glow = "purple",
      desc = "Hair colour + free recolor of hair & beard." },
    { key = "facial",    label = "Facial Hair", fb = 7,  region = 3, color = false, glow = "gold",
